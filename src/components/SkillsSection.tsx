  ...
  return (
    <section className="py-16 md:py-20 px-4 sm:px-6 md:px-8 parallax-section" id="skills">
      <div className="container mx-auto max-w-6xl">
        <h2 data-reveal className="text-3xl md:text-4xl lg:text-5xl font-bold mb-3 text-center text-gradient">Skills</h2>
        ...
        <div className="grid gap-6 md:gap-8 md:grid-cols-2" data-reveal-group="scale">
